...
/// The input schema is automatically generated by introspecting the Move module's "execute_v1" function.
...
async fn generate_and_customize_schemas(
    ...
    // Generate input schema by introspecting the Move module's "execute_v1" function.
