...
use {
    ...
    nexus_sdk::{
        nexus::tap::{
            fetch_agent_payment_vault_for_agent, CreateAgentResult, GetSkillRequirementResult,
            PublishSkillResult, RegisterSkillResult, TapPackagePublishOptions, UpdateSkillResult,
        },
    ...
    tap_common::{
        agent_id_from_alias_or_arg, ensure_cli_agent_owner, ensure_cli_mutable_agent,
        read_artifact, schedule_policy_from_cli,
    },
    ...
    tap_output::{
        agent_list_result_json, agent_remove_result_json, agent_save_result_json, bind_result_json,
        create_agent_result_json, create_skill_artifact_result_json, default_agent_result_json,
        dry_run_result_json, payment_show_result_json, payment_wait_result_json,
        publish_skill_result_json, register_skill_result_json, registry_show_result_json,
        render_agent_list, render_agent_remove, render_default_agent, render_payment,
        render_payment_wait, render_registry, render_requirements, render_vault_balance,
        requirements_result_json, scaffold_result_json, update_skill_result_json,
        validate_skill_result_json, vault_balance_result_json, vault_deposit_result_json,
    },
