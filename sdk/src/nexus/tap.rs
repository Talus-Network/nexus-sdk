...
use {
    crate::{
        ...
        move_bindings::{
            interface::{
                agent::{
                    Agent, AgentPaymentVault, AgentPaymentVaultStateV1, AgentVaultFieldKey,
                    SkillDagBinding, SkillRequirement,
                },
                payment::{ExecutionPayment, ExecutionPaymentFinalState},
                version::InterfaceVersion,
            },
            registry::agent_registry::{
                AgentRecord, AgentRegistry, AgentRegistryStateV1, DefaultDagExecutor,
                DefaultDagExecutorFieldKey, SkillRecord,
            },
        ...
        types::{
            resolve_active_tap_skill_revision, ActiveSkillExecutionTarget, AgentId,
            AgentRecordContext, AgentRegistrySnapshot, DefaultDagExecutorRecord, NexusObjects,
            SkillId, SkillRecordContext, SkillRevisionContext, SkillRevisionLookupError,
            SkillRevisionLookupKey, TapPublishArtifact,
        },
    },
    ...
    use {
        ...
        crate::{
            move_bindings::{
                interface::{
                    agent::{
                        self as agent_binding, Agent, AgentPaymentVaultStateV1, SkillDagBinding,
                        SkillRequirement, SkillSchedulePolicy,
                    },
                ...
                registry::agent_registry::{
                    self as agent_registry_binding, AgentRecord, AgentRegistry,
                    AgentRegistryStateV1, DefaultDagExecutor, DefaultDagExecutorFieldKey,
                    SkillRecord,
                },
                sui_framework::{
                    table::Table as MoveTable, transfer as transfer_binding, versioned::Versioned,
                },
            },
            test_utils::{nexus_mocks, sui_mocks},
            types::{
                resolve_active_tap_skill_execution_target, AgentRegistrySnapshot,
                DefaultDagExecutorTarget, NexusObjects, SkillConfig, SkillRecordContext,
