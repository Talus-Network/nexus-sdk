...
pub mod dag {
    ...
    pub fn assert_execution_matches_leader_cap(
        arg0: &impl sm_call::ObjectArg<DAGExecution>,
        arg1: &impl sm_call::ObjectArg<
            super::primitives::owner_cap::CloneableOwnerCap<super::leader_cap::OverNetwork>,
        >,
    ) -> sm_call::CallSpec {
        let mut spec =
    ...
    pub fn encrypted_input_port_from_string(arg0: sm::ascii::String) -> sm_call::CallSpec {
        let mut spec = sm_call::CallSpec::new(PACKAGE, "dag", "encrypted_input_port_from_string")
            .expect("valid Move identifiers");
        spec.push_arg(&arg0).expect("encode arg");
        spec
    }
    ...
    /// Note: this function is not marked `entry`.
    #[must_use]
    pub fn execution_created_at(arg0: &impl sm_call::ObjectArg<DAGExecution>) -> sm_call::CallSpec {
    ...
    /// Note: this function is not marked `entry`.
    #[must_use]
    pub fn execution_invoker(arg0: &impl sm_call::ObjectArg<DAGExecution>) -> sm_call::CallSpec {
    ...
    /// Note: this function is not marked `entry`.
    #[must_use]
    pub fn execution_network(arg0: &impl sm_call::ObjectArg<DAGExecution>) -> sm_call::CallSpec {
    ...
    pub fn request_network_to_execute_walks(
        ...
        let mut spec = sm_call::CallSpec::new(PACKAGE, "dag", "request_network_to_execute_walks")
            .expect("valid Move identifiers");
        spec.push_arg(arg0).expect("encode arg");
    ...
    pub fn request_walk_execution_vertices(
        ...
        let mut spec = sm_call::CallSpec::new(PACKAGE, "dag", "request_walk_execution_vertices")
            .expect("valid Move identifiers");
        spec.push_arg(&arg0).expect("encode arg");
        spec.push_arg(arg1).expect("encode arg");
        spec.push_arg(arg2).expect("encode arg");
    ...
    /// Note: this function is not marked `entry`.
    #[must_use]
    pub fn request_walk_execution_walks_indices(arg0: RequestWalkExecution) -> sm_call::CallSpec {
        let mut spec =
    ...
    pub fn runtime_vertex_plain_from_string(arg0: sm::ascii::String) -> sm_call::CallSpec {
        let mut spec = sm_call::CallSpec::new(PACKAGE, "dag", "runtime_vertex_plain_from_string")
            .expect("valid Move identifiers");
        spec.push_arg(&arg0).expect("encode arg");
        spec
    }
    ...
    pub fn runtime_vertex_plain_from_vertex(arg0: Vertex) -> sm_call::CallSpec {
        let mut spec = sm_call::CallSpec::new(PACKAGE, "dag", "runtime_vertex_plain_from_vertex")
            .expect("valid Move identifiers");
        spec.push_arg(&arg0).expect("encode arg");
        spec
    }
    ...
    pub fn submit_on_chain_tool_eval_for_walk(
        ...
        let mut spec = sm_call::CallSpec::new(PACKAGE, "dag", "submit_on_chain_tool_eval_for_walk")
            .expect("valid Move identifiers");
        spec.push_arg(arg0).expect("encode arg");
        spec.push_arg_mut(arg1).expect("encode arg");
        spec.push_arg(&arg2).expect("encode arg");
    ...
    pub fn vertex_name(arg0: RuntimeVertex) -> sm_call::CallSpec {
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "dag", "vertex_name").expect("valid Move identifiers");
        spec.push_arg(&arg0).expect("encode arg");
        spec
    }
    ...
    pub fn with_edge(
        ...
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "dag", "with_edge").expect("valid Move identifiers");
        spec.push_arg(arg0).expect("encode arg");
        spec.push_arg(&arg1).expect("encode arg");
        spec.push_arg(&arg2).expect("encode arg");
        spec.push_arg(&arg3).expect("encode arg");
    ...
    pub fn with_entry(arg0: &impl sm_call::ObjectArg<DAG>, arg1: Vertex) -> sm_call::CallSpec {
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "dag", "with_entry").expect("valid Move identifiers");
        spec.push_arg(arg0).expect("encode arg");
        spec.push_arg(&arg1).expect("encode arg");
        spec
    }
    ...
    pub fn with_output(
        ...
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "dag", "with_output").expect("valid Move identifiers");
        spec.push_arg(arg0).expect("encode arg");
        spec.push_arg(&arg1).expect("encode arg");
        spec.push_arg(&arg2).expect("encode arg");
        spec.push_arg(&arg3).expect("encode arg");
    ...
    pub fn with_vertex(
        ...
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "dag", "with_vertex").expect("valid Move identifiers");
        spec.push_arg(arg0).expect("encode arg");
        spec.push_arg(&arg1).expect("encode arg");
        spec.push_arg(&arg2).expect("encode arg");
        spec
...
pub mod default_tap {
    ...
    pub struct DefaultTAP {
        ...
        pub iv: super::interface::version::InterfaceVersion,
    }
    ...
    pub fn confirm_tool_eval_for_walk(
        ...
        let mut spec = sm_call::CallSpec::new(PACKAGE, "default_tap", "confirm_tool_eval_for_walk")
            .expect("valid Move identifiers");
        spec.push_arg_mut(arg0).expect("encode arg");
        spec.push_arg(&arg1).expect("encode arg");
        spec
    ...
    pub fn dag_begin_execution_from_scheduler(
        ...
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "default_tap", "dag_begin_execution_from_scheduler")
                .expect("valid Move identifiers");
        spec.push_arg_mut(arg0).expect("encode arg");
        spec.push_arg_mut(arg1).expect("encode arg");
        spec.push_arg(arg2).expect("encode arg");
    ...
    pub fn register_begin_execution(
        arg0: &mut impl sm_call::ObjectArg<
            super::primitives::policy::Policy<super::scheduler::Execution>,
        >,
        arg1: super::dag::DagExecutionConfig,
    ) -> sm_call::CallSpec {
        let mut spec = sm_call::CallSpec::new(PACKAGE, "default_tap", "register_begin_execution")
            .expect("valid Move identifiers");
        spec.push_arg_mut(arg0).expect("encode arg");
        spec.push_arg(&arg1).expect("encode arg");
        spec
...
pub mod gas {
    ...
    pub fn add_gas_ticket(
        ...
        arg2: &impl sm_call::ObjectArg<super::primitives::owner_cap::CloneableOwnerCap<OverGas>>,
    ...
    pub fn claim_gas(
        arg0: &mut impl sm_call::ObjectArg<GasService>,
        arg1: &impl sm_call::ObjectArg<super::tool_registry::ToolRegistry>,
        arg2: &impl sm_call::ObjectArg<
            super::primitives::owner_cap::CloneableOwnerCap<super::tool_registry::OverTool>,
        >,
        arg3: sm::ascii::String,
    ) -> sm_call::CallSpec {
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "gas", "claim_gas").expect("valid Move identifiers");
        spec.push_arg_mut(arg0).expect("encode arg");
        spec.push_arg(arg1).expect("encode arg");
        spec.push_arg(arg2).expect("encode arg");
        spec.push_arg(&arg3).expect("encode arg");
    ...
    pub fn deescalate(
        ...
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "gas", "deescalate").expect("valid Move identifiers");
        spec.push_arg(arg0).expect("encode arg");
        spec.push_arg(arg1).expect("encode arg");
        spec.push_arg(&arg2).expect("encode arg");
        spec
    ...
    pub fn modus_operandi_limited_invocations(arg0: u64, arg1: u64) -> sm_call::CallSpec {
        let mut spec = sm_call::CallSpec::new(PACKAGE, "gas", "modus_operandi_limited_invocations")
            .expect("valid Move identifiers");
        spec.push_arg(&arg0).expect("encode arg");
        spec.push_arg(&arg1).expect("encode arg");
        spec
    ...
    pub fn modus_operandi_upon_discretion_of_the_tool() -> sm_call::CallSpec {
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "gas", "modus_operandi_upon_discretion_of_the_tool")
                .expect("valid Move identifiers");
        spec
    }
    ...
    pub fn set_single_invocation_cost_mist(
        ...
        let mut spec = sm_call::CallSpec::new(PACKAGE, "gas", "set_single_invocation_cost_mist")
            .expect("valid Move identifiers");
        spec.push_arg_mut(arg0).expect("encode arg");
        spec.push_arg(arg1).expect("encode arg");
        spec.push_arg(arg2).expect("encode arg");
...
pub mod gas_extension {
    ...
    pub fn buy_expiry_gas_ticket(
        ...
        let mut spec = sm_call::CallSpec::new(PACKAGE, "gas_extension", "buy_expiry_gas_ticket")
            .expect("valid Move identifiers");
        spec.push_arg_mut(arg0).expect("encode arg");
        spec.push_arg(arg1).expect("encode arg");
        spec.push_arg(&arg2).expect("encode arg");
    ...
    pub fn disable_expiry(
        ...
        arg1: &impl sm_call::ObjectArg<super::tool_registry::ToolRegistry>,
        arg2: &impl sm_call::ObjectArg<
            super::primitives::owner_cap::CloneableOwnerCap<super::gas::OverGas>,
        >,
        arg3: sm::ascii::String,
    ) -> sm_call::CallSpec {
...
pub mod leader_cap {
    ...
    pub fn new() -> sm_call::CallSpec {
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "leader_cap", "new").expect("valid Move identifiers");
        spec
    }
}
...
pub mod pre_key_vault {
    ...
    pub fn claim_pre_key_for_self(
        ...
        let mut spec = sm_call::CallSpec::new(PACKAGE, "pre_key_vault", "claim_pre_key_for_self")
            .expect("valid Move identifiers");
        spec.push_arg_mut(arg0).expect("encode arg");
        spec.push_arg(arg1).expect("encode arg");
        spec.push_arg(arg2).expect("encode arg");
    ...
    pub fn fulfill_pre_key_for_user(
        arg0: &mut impl sm_call::ObjectArg<PreKeyVault>,
        arg1: &impl sm_call::ObjectArg<super::primitives::owner_cap::CloneableOwnerCap<OverCrypto>>,
        arg2: sm::prelude::Address,
        arg3: Vec<u8>,
    ) -> sm_call::CallSpec {
        let mut spec = sm_call::CallSpec::new(PACKAGE, "pre_key_vault", "fulfill_pre_key_for_user")
            .expect("valid Move identifiers");
        spec.push_arg_mut(arg0).expect("encode arg");
        spec.push_arg(arg1).expect("encode arg");
        spec.push_arg(&arg2).expect("encode arg");
...
pub mod scheduler {
    ...
    pub struct Metadata {
        pub values: sm::vec_map::VecMap<sm::string::String, sm::string::String>,
    }
    ...
    pub struct QueueGeneratorState {
        pub pending: sm::priority_queue::PriorityQueue<QueueEntry>,
        pub len: u64,
    ...
    pub struct Task {
        ...
        pub constraints: super::primitives::policy::Policy<Constraints>,
        pub execution: super::primitives::policy::Policy<Execution>,
        pub state: State,
        pub data: sm::bag::Bag,
    ...
    pub fn cancel(arg0: &mut impl sm_call::ObjectArg<Task>) -> sm_call::CallSpec {
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "scheduler", "cancel").expect("valid Move identifiers");
        spec.push_arg_mut(arg0).expect("encode arg");
        spec
    }
    ...
    pub fn check_periodic_occurrence(
        ...
        let mut spec = sm_call::CallSpec::new(PACKAGE, "scheduler", "check_periodic_occurrence")
            .expect("valid Move identifiers");
        spec.push_arg_mut(arg0).expect("encode arg");
        spec.push_arg(arg1).expect("encode arg");
        spec
    ...
    pub fn disable_periodic_for_task(
        ...
        let mut spec = sm_call::CallSpec::new(PACKAGE, "scheduler", "disable_periodic_for_task")
            .expect("valid Move identifiers");
        spec.push_arg_mut(arg0).expect("encode arg");
        spec
    }
    ...
    pub fn finish(
        ...
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "scheduler", "finish").expect("valid Move identifiers");
        spec.push_arg_mut(arg0).expect("encode arg");
        spec.push_arg(&arg1).expect("encode arg");
        spec
    }
    ...
    pub fn new(
        arg0: Metadata,
        arg1: &impl sm_call::ObjectArg<super::primitives::policy::Policy<Constraints>>,
        arg2: &impl sm_call::ObjectArg<super::primitives::policy::Policy<Execution>>,
    ) -> sm_call::CallSpec {
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "scheduler", "new").expect("valid Move identifiers");
        spec.push_arg(&arg0).expect("encode arg");
        spec.push_arg(arg1).expect("encode arg");
        spec.push_arg(arg2).expect("encode arg");
        spec
    ...
    #[must_use]
    pub fn new_metadata(
        arg0: sm::vec_map::VecMap<sm::string::String, sm::string::String>,
    ) -> sm_call::CallSpec {
    ...
    pub fn new_periodic_generator_state() -> sm_call::CallSpec {
        let mut spec = sm_call::CallSpec::new(PACKAGE, "scheduler", "new_periodic_generator_state")
            .expect("valid Move identifiers");
        spec
    }
    ...
    pub fn new_queue_generator_state() -> sm_call::CallSpec {
        let mut spec = sm_call::CallSpec::new(PACKAGE, "scheduler", "new_queue_generator_state")
            .expect("valid Move identifiers");
        spec
    }
    ...
    pub fn pause(arg0: &mut impl sm_call::ObjectArg<Task>) -> sm_call::CallSpec {
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "scheduler", "pause").expect("valid Move identifiers");
        spec.push_arg_mut(arg0).expect("encode arg");
        spec
    }
    ...
    pub fn register_periodic_generator(
        arg0: &mut impl sm_call::ObjectArg<super::primitives::policy::Policy<Constraints>>,
        arg1: PeriodicGeneratorState,
    ) -> sm_call::CallSpec {
        let mut spec = sm_call::CallSpec::new(PACKAGE, "scheduler", "register_periodic_generator")
            .expect("valid Move identifiers");
        spec.push_arg_mut(arg0).expect("encode arg");
        spec.push_arg(&arg1).expect("encode arg");
        spec
    ...
    pub fn resume(arg0: &mut impl sm_call::ObjectArg<Task>) -> sm_call::CallSpec {
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "scheduler", "resume").expect("valid Move identifiers");
        spec.push_arg_mut(arg0).expect("encode arg");
        spec
    }
...
pub mod tool_output {
    ...
    pub fn err(arg0: Vec<u8>) -> sm_call::CallSpec {
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "tool_output", "err").expect("valid Move identifiers");
        spec.push_arg(&arg0).expect("encode arg");
        spec
    }
    ...
    pub fn new(arg0: Vec<u8>) -> sm_call::CallSpec {
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "tool_output", "new").expect("valid Move identifiers");
        spec.push_arg(&arg0).expect("encode arg");
        spec
    }
    ...
    pub fn ok() -> sm_call::CallSpec {
        let mut spec =
            sm_call::CallSpec::new(PACKAGE, "tool_output", "ok").expect("valid Move identifiers");
        spec
    }
...
pub mod tool_registry {
    ...
    pub fn add_allowed_owner(
        ...
        arg1: &impl sm_call::ObjectArg<super::primitives::owner_cap::CloneableOwnerCap<OverSlashing>>,
        arg2: sm::prelude::Address,
    ) -> sm_call::CallSpec {
    ...
    pub fn assert_onchain_tool_owner(
        ...
        arg1: &impl sm_call::ObjectArg<super::primitives::owner_cap::CloneableOwnerCap<OverTool>>,
        arg2: sm::ascii::String,
    ) -> sm_call::CallSpec {
        let mut spec =
    ...
    pub fn assert_onchain_tool_owner_unchecked_generic<T0>(
        arg0: &impl sm_call::ObjectArg<ToolRegistry>,
        arg1: &impl sm_call::ObjectArg<super::primitives::owner_cap::CloneableOwnerCap<T0>>,
        arg2: sm::ascii::String,
    ) -> sm_call::CallSpec
    where
        T0: sm::MoveType,
    ...
    pub fn assert_tool_registered(
        ...
        let mut spec = sm_call::CallSpec::new(PACKAGE, "tool_registry", "assert_tool_registered")
            .expect("valid Move identifiers");
        spec.push_arg(arg0).expect("encode arg");
        spec.push_arg(&arg1).expect("encode arg");
        spec
    ...
    pub fn onchain_tool_module_name(
        ...
        let mut spec = sm_call::CallSpec::new(PACKAGE, "tool_registry", "onchain_tool_module_name")
            .expect("valid Move identifiers");
        spec.push_arg(arg0).expect("encode arg");
        spec.push_arg(&arg1).expect("encode arg");
        spec
    ...
    pub fn onchain_tool_witness_id(
        ...
        let mut spec = sm_call::CallSpec::new(PACKAGE, "tool_registry", "onchain_tool_witness_id")
            .expect("valid Move identifiers");
        spec.push_arg(arg0).expect("encode arg");
        spec.push_arg(&arg1).expect("encode arg");
        spec
    ...
    pub fn register_off_chain_tool(
        ...
        let mut spec = sm_call::CallSpec::new(PACKAGE, "tool_registry", "register_off_chain_tool")
            .expect("valid Move identifiers");
        spec.push_arg_mut(arg0).expect("encode arg");
        spec.push_arg(&arg1).expect("encode arg");
        spec.push_arg(&arg2).expect("encode arg");
    ...
    pub fn register_on_chain_tool(
        ...
        let mut spec = sm_call::CallSpec::new(PACKAGE, "tool_registry", "register_on_chain_tool")
            .expect("valid Move identifiers");
        spec.push_arg_mut(arg0).expect("encode arg");
        spec.push_arg(&arg1).expect("encode arg");
        spec.push_arg(&arg2).expect("encode arg");
