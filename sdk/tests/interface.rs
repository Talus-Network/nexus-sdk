...
pub mod v1 {
    ...
    #[must_use]
    pub fn announce_interface_package<T0>(
        arg0: T0,
        arg1: Vec<sm::types::ID>,
    ) -> sm_call::CallSpec
    where
        T0: sm::MoveType,
    {
...
pub mod version {
    ...
    pub fn expect_v(arg0: InterfaceVersion, arg1: u64) -> sm_call::CallSpec {
        let mut spec = sm_call::CallSpec::new(PACKAGE, "version", "expect_v")
            .expect("valid Move identifiers");
        spec.push_arg(&arg0).expect("encode arg");
        spec.push_arg(&arg1).expect("encode arg");
        spec
    ...
    pub fn number(arg0: InterfaceVersion) -> sm_call::CallSpec {
        let mut spec = sm_call::CallSpec::new(PACKAGE, "version", "number")
            .expect("valid Move identifiers");
        spec.push_arg(&arg0).expect("encode arg");
        spec
    }
    ...
    pub fn v(arg0: u64) -> sm_call::CallSpec {
        let mut spec = sm_call::CallSpec::new(PACKAGE, "version", "v")
            .expect("valid Move identifiers");
        spec.push_arg(&arg0).expect("encode arg");
        spec
    }
...
pub use v1::AnnounceInterfacePackageEvent;
