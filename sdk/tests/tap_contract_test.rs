...
use {
    nexus_sdk::{
        move_bindings::{
            interface::{
                agent::{
                    self as agent_binding, FixedTool, SkillDagBinding, SkillRecurrenceKind,
            ...
            registry::agent_registry::{
                self as agent_registry_binding, AgentRecord, DefaultDagExecutor, SkillRecord,
            },
            struct_tag,
        ...
        types::{
            resolve_active_tap_skill_revision, AgentRegistrySnapshot, DefaultDagExecutorTarget,
            NexusObjects, SkillConfig, SkillRecordContext, SkillRevisionContext,
            SkillRevisionLookupError, SkillRevisionLookupKey,
        },
    },
